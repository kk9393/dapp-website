class Game {
    ...
    * Display score
    ...
    showGrade(score) {
        ...
        else if(score > 13) return "Nice! Come on...";
        else if(score > 10) return "Good Job! Keep it up";
        else if(score > 5) return "Really? Try harder!";
        else return "Poor! You can do better...";
    }
